DB = [
  ...
  },
  {
    ...
    rating: "2",
    comments: ["J'ai préféré l'autre article", "je n'ai pas vraiment compris le deuxième paragraphe", "une suite?"]
  },
  {
    ...
    rating: "4",
    comments: ["A revoir", "Découvrez ma page Facebook! @Kamsoerzi"]
  },
  {
  ...
  },
  {
    ...
    rating: "4",
    comments: ["J'ai adoré mais j'aurais préféré qu'elle finisse avec John", "good article", "Ajouté dans mes favoris!"]
  }
]
